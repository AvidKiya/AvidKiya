  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-black mb-2">پشتیبانی</h1>
        <p className="text-text-2">سوال یا مشکلی دارید؟ با ما در تماس باشید.</p>
      </div>
      ...
      <div className="mt-8 text-center text-text-2 text-sm">
        <p>
          یا از طریق ایمیل{' '}
          <a href="mailto:support@avidkiya.com" className="text-primary hover:underline">
            support@avidkiya.com
          </a>{' '}
          با ما تماس بگیرید.
        </p>
      </div>
